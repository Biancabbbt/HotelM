<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Users/UserMaster.Master" AutoEventWireup="true" CodeBehind="Double.aspx.cs" Inherits="HotelM.Views.Users.Double" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Mybody" runat="server">
  ...
  <img class="card-img-top" src="../../Assets/Images/double.jpg" >
                                 <div class="rd-text">
                            <div class="rd-title">
                                <h3>Double Room</h3>
                                <div class="rdt-right">
                      ...
                      <h2>259$<span>/Per noapte</span></h2>
                            <table>
                                <tbody>
                                    <tr>
