<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Users/UserMaster.Master" AutoEventWireup="true" CodeBehind="Small.aspx.cs" Inherits="HotelM.Views.Users.Small" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Mybody" runat="server">
  ...
  <img class="card-img-top" src="../../Assets/Images/onep.jpg" >
                                 <div class="rd-text">
                            <div class="rd-title">
                                <h3>Small View</h3>
                                <div class="rdt-right">
                      ...
                      <h2>119$<span>/Per noapte</span></h2>
                            <table>
                                <tbody>
                                    <tr>
