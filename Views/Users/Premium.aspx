<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Users/UserMaster.Master" AutoEventWireup="true" CodeBehind="Premium.aspx.cs" Inherits="HotelM.Views.Users.Booking_Premium" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Mybody" runat="server">
 <section class="room-details-section spad" style="	padding-top: 40px;" >
  ...
  <img class="card-img-top" src="../../Assets/Images/premium.jpg" >
                                 <div class="rd-text">
                            <div class="rd-title">
                      ...
                      <h2>359$<span>/Per noapte</span></h2>
                            <table>
                                <tbody>
                                    <tr>
