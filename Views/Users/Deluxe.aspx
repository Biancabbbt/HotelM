<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Users/UserMaster.Master" AutoEventWireup="true" CodeBehind="Deluxe.aspx.cs" Inherits="HotelM.Views.Users.Deluxe" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Mybody" runat="server">
 <section class="room-details-section spad" style="	padding-top: 40px;" >
  ...
  <img class="card-img-top" src="../../Assets/Images//deluxe2.jpeg" >
                                 <div class="rd-text">
                            <div class="rd-title">
                                <h3>Deluxe Room</h3>
                                <div class="rdt-right">
                      ...
                      <h2>299$<span>/Per noapte</span></h2>
                            <table>
                                <tbody>
                                    <tr>
